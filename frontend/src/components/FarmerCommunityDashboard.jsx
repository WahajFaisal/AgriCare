...
import Picture from '../Assets/community.jpg'

const FarmerCommunityDashboard = () => {
  return (
    <div className='w-full bg-white py-16 px-4'>
<div className='max-w-[1240px] mx-auto grid md:grid-cols-2'>
<img className='w-[500px] mx-auto my-4' src={Picture} alt="/" />
<div className='flex flex-col justify-center'>
    <p className='text-[#00df9a] font-bold'>FARMER COMMUNITY DASHBOARD</p>
    <h1 className='md:text-4xl sm:text-3xl text-2xl font-bold py-2'>Get into the biggest community</h1>
    <p>
...
export default FarmerCommunityDashboard